...
sys.path.append('../../txf_design-space/transformers/src/transformers/models/bert/modeling_modular_bert')
...
# from modeling_modular_bert import BertModelModular, BertForMaskedLMModular, BertForSequenceClassificationModular
